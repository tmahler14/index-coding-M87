...
public class GaugeView extends View {
    ...
    private double internalArcStrokeWidthScale = 0.275;
    private double paddingInnerCircleScale = 0.18;
    private double pointerLineStrokeWidthScale = 0.006944;
    private float mainCircleScale = 6;
